...
Most backend engineers are not familiar with mobile design patterns, go to [iOS Architecture Patterns](https://tianpan.co/blog/123-ios-architecture-patterns-revisited) for more.
